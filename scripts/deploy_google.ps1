<#
    ...
    Lives in scripts\ ; builds the project root one level up.
    Run:  double-click deploy_google.bat at the project root.
...
# This script sits in scripts\ but the thing being deployed is the project
# root one level up - that is where the Dockerfile, main.py and web\ are, and
# "--source ." is resolved from the working directory.
...
Write-Host ''
Say "building from $ROOT and deploying to $region" 'Cyan'
